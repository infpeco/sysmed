...
$Codigo=$_POST["Codigo"];
$sql = "SELECT `id`,`Nombre`,`Apellido`,`Direccion`,`Identificacion`,`TipoIdentificacion`,`Sexo`,`TipoSangre`,`SeguroSocial`,`Area`, `Departamento`, `Cargo`,`FechaEntrada`,`FechaNacimiento`,`Correo`,`Estado`,`Experiencia`,`Escolaridad` FROM `empleado` WHERE `id`=$Codigo AND  `Tipo`='Empleado'";

...
$Codigo=$_POST["Codigo"];
$sql = "SELECT `id`,`Nombre`,`Apellido`,`Direccion`,`Identificacion`,`TipoIdentificacion`,`Sexo`,`TipoSangre`,`SeguroSocial`,`Especialidad`,`FechaEntrada`,`FechaNacimiento`,`Correo`,`Estado`,`Experiencia`,`Escolaridad` FROM `empleado` WHERE `id`=$Codigo AND  `Tipo`='Enfermera'";
